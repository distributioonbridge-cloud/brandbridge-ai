    ...
    <header className="sticky top-0 z-50 glass-panel border-b border-slate-800/80 bg-[#0b0f19]/90 backdrop-blur-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        >
          <img
            src="/logo.jpg"
            alt="Distribution Bridge AI"
            className="h-10 sm:h-11 w-auto rounded-lg object-contain group-hover:scale-105 transition-transform shadow-md border border-cyan-500/20"
          />
        </div>
